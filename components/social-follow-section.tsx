...
export function SocialFollowSection() {
  ...
  return (
    <section className="relative z-10 py-8 px-4 bg-gradient-to-b from-black/30 to-black/50">
          ...
          {socialPlatforms.map((platform) => (
            <a
              ...
              className={`
                ...
                ${hoveredCard === platform.id ? "transform scale-125" : "hover:scale-110"}
              `}
            ...
            >
              <div
                className={`
                  ...
                  ${hoveredCard === platform.id ? `${platform.glowColor} shadow-2xl` : ""}
